...
export default function Home() {
  ...
  return (
    ...
    <section id="home" className="flex justify-center w-full bg-linear-to-b from-[#FED000] to-[#fec300] {!py-16} !pt-4">
      <div className="flex flex-row gap-10 text-white w-full max-w-[1000px]">
        <div className="self-center w-6/12">
          <div className="home-text-content {max-w-[475px] !mr-auto}">
            <div className="flex flex-col gap-3">
              <h1 className="text-2xl !font-['DancingScript'] font-semibold">A melhor OPÇÃO da Casa!</h1>
              <h2 className="text-[#ce9009] [font-size:var(--h2-home)] font-bold tracking-tight !leading-[.8em] hover:transform-[scale(1.01)] active:transform-[scale(1.01)] transition-transform duration-300">CLONE</h2>
        ...
        <picture className="home-img-container w-6/12">
          <img src="https://forneriadacasa.vercel.app/assets/pizza1-CBxKWArt.webp" alt="#" className="h-full w-full object-contain aspect-[650/660] pointer-events-none" loading="eager" decoding="sync" fetchPriority="high" />
        </picture>
      </div>
    </section>

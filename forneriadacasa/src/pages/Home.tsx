        ...
        <div className="home-text-content self-center w-6/12">
          <div>
            ...
            <aside className="home-aside-content flex items-center flex-row gap-2.5 !mt-3">
              ...
              <span className="home-price-aside text-[var(--price-home-color-1)] text-[clamp(1.25rem,6.4vw,1.475rem)] sm:text-[1.475rem] font-bold">R$ 62,00</span>
              <small className="text-[var(--price-home-color-2)] text-[clamp(.775rem,3.95vw,.875rem)] sm:text-[.875rem] line-through">R$ 78,00</small>
            </aside>
          </div>
        </div>

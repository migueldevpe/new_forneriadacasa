    ...
    <div className="flex items-center justify-center flex-col gap-8">
      <div id="salgadas" className="scroll-mt-[88px] w-full">
        ...
        <div className="cards-container grid gap-4 h-fit w-full">
          {/* <Card 
            img="https://placehold.co/225x200/cdcdcd/c10007?text=Marguerita" 
          ...
          <Card 
            ...
            valor="44,99" />
          <Card 
            img="https://placehold.co/225x200/cdcdcd/000?text=3+Queijos" 
            ...
            valor="41,99"/>
          <Card 
            img="https://placehold.co/225x200/cdcdcd/000?text=Calabresa" 
          ...
          <Card 
            ...
            valor="44,99" />
          <Card 
            img="https://placehold.co/225x200/cdcdcd/000?text=Calabresa+c/+Barbecue" 
          ...
          <Card 
            ...
            valor="44,99" />
          <Card 
            img="https://placehold.co/225x200/cdcdcd/000?text=Frango+c/+Cheddar" 
            ...
            valor="44,99" />
          <Card 
            img="https://placehold.co/225x200/cdcdcd/000?text=Frango+Tropical" 
            ...
            valor="44,99" />
          <Card 
            img="https://placehold.co/225x200/cdcdcd/000?text=Frango+c/+Barbecue" 
